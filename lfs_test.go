...
func TestPackageSystemProfiles(t *testing.T) {
	...
	for _, descriptor := range descriptors {
		if strings.Contains(descriptor, "/package-blfs-template/") {
			continue
		}
		content, err := os.ReadFile(descriptor)
		if err != nil {
	...
	if len(full) != 446 {
		t.Fatalf(
			"full profile resolves %d of %d packages, expected 446",
			len(full), len(dependencies),
		)
	}
	intentionallyExcluded := map[string]bool{
		"pnmixer": true,
		"sassc":   true,
		"xine-ui": true,
	}
	for name := range dependencies {
		if !full[name] && !intentionallyExcluded[name] {
			t.Errorf("full profile unexpectedly excludes %s", name)
		}
	}
	for name := range intentionallyExcluded {
		if full[name] {
			t.Errorf("full profile unexpectedly includes %s", name)
		}
	}
	...
	desktopSway := resolve("desktop-sway")
	for _, required := range []string{
		"sway", "foot", "waybar", "pipewire", "wireplumber",
		"xdg-desktop-portal-wlr", "polkit-gnome", "networkmanager",
		"dunst", "swayidle", "swaylock", "linux-kernel", "openssh",
	} {
		if !desktopSway[required] {
			t.Errorf("desktop-sway profile is missing %s", required)
		}
	}
	for _, excluded := range []string{"rustc", "cargo-c"} {
		if desktopSway[excluded] {
			t.Errorf("desktop-sway profile unexpectedly resolves %s", excluded)
		}
	}
	if desktopSway["gcc"] {
		t.Errorf("desktop-sway profile unexpectedly resolves gcc")
	}
	if len(desktopSway) <= len(minimal) || len(desktopSway) >= len(full) {
		t.Errorf(
			"desktop-sway profile resolves %d packages; minimal resolves %d and full resolves %d",
			len(desktopSway), len(minimal), len(full),
		)
	}
	t.Logf("desktop-sway profile resolves %d packages", len(desktopSway))
}
...
func TestExampleDescriptorsAreValid(t *testing.T) {
	tests := []struct {
		...
		{folder: "native/package-libstdcxx-runtime", descriptorName: "xbee-pack-builder.yaml"},
		...
		{folder: "native/package-blfs-linux-pam", descriptorName: "xbee-pack-builder.yaml"},
		...
		{folder: "native/package-blfs-seatd", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-hwdata", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libdisplay-info", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libdrm", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libpciaccess", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-mako", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-pyyaml", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-mesa", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-json-c", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libliftoff", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-wlroots", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-sway", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-swaybg", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-wmenu", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-tllist", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-fcft", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-foot", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-wl-clipboard", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-grim", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-slurp", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libscfg", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-kanshi", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-fmt", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-spdlog", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-jsoncpp", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libsigcxx", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libsigcxx3", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-glibmm", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-glibmm2", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cairomm", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cairomm16", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-pangomm", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-pangomm248", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-at-spi2-core", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-graphene", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-iso-codes", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gtk4", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gtkmm4", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-pavucontrol", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libogg", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libvorbis", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libcanberra", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-sound-theme-freedesktop", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-alsa-utils", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-alsa-tools", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-alsa-firmware", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-audiofile", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-nasm", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-dav1d", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-faac", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-faad2", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-fdk-aac", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-flac", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gavl", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-frei0r", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libepoxy", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-atkmm", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gtk3", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gtkmm", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gtk-layer-shell", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-waybar", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libnl", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-pulseaudio", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libsndfile", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-alsa-lib", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-pipewire", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-lua", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-wireplumber", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-dejavu-fonts", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-liberation-fonts", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-fuse3", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-json-glib", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-bubblewrap", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-inih", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gstreamer", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gst-plugins-base", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gst-plugins-good", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gst-plugins-bad", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gst-plugins-ugly", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-git", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gst-plugins-rs", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-ffmpeg", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gst-libav", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-id3lib", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gmmlib", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libva", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-intel-media-driver", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-intel-vaapi-driver", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-liba52", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libao", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libaom", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libass", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libcddb", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libcdio", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libde265", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libdvdcss", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libdvdread", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libdvdnav", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libdv", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libmad", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libmpeg2", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-neon", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libmusicbrainz", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-glad", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libplacebo", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-vulkan-headers", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libsamplerate", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libvpx", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-mlt", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-opus", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-sbc", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-sdl3", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-sdl2-compat", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-soundtouch", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-speex", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-svt-av1", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-utfcpp", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-taglib", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-v4l-utils", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-x264", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-x265", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-xine-lib", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-qt6", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-extra-cmake-modules", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-breeze-icons", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-plasma-wayland-protocols", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libgpg-error", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libgcrypt", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libical", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libsecret", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-lmdb", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-qca", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libqrencode", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-perl-mime-base32", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-perl-uri", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-perl-parse-yapp", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-kf6-frameworks", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-fftw", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-xvid", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-audacious", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cdparanoia", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-kwave", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-lame", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-mpg123", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-pnmixer", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-vorbis-tools", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-mpv", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-vlc", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-xine-ui", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cdrdao", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cdrtools", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-dvd-rw-tools", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libburn", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libisoburn", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libisofs", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-xdg-desktop-portal", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-xdg-desktop-portal-wlr", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gsettings-desktop-schemas", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-xdg-desktop-portal-gtk", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-desktop-file-utils", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-hicolor-icon-theme", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-xdg-user-dirs", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-rustc", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cargo-c", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-librsvg", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-adwaita-icon-theme", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libnotify", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-dunst", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-swayidle", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-swaylock", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-duktape", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-polkit", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-accountsservice", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-polkit-gnome", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libndp", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-wpa-supplicant", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-networkmanager", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-nettle", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libtasn1", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-p11-kit", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-make-ca", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gnutls", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libusb", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libdaemon", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-avahi", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-lcms2", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libexif", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libwebp", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-openjpeg", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-poppler", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-qpdf", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-colord", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libgusb", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-python-lxml", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-itstool", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libadwaita", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cups", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-ghostscript", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gutenprint", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libcupsfilters", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libppd", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cups-filters", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cups-browsed", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-sane", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-simple-scan", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libgudev", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-keyutils", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libaio", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-popt", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-python-pygments", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libatasmart", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libbytesize", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libnvme", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-lvm2", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cryptsetup", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-parted", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libblockdev", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-udisks", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-upower", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-boost", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gobject-introspection", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-exiv2", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gexiv2", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libgsf", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libhandy", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libcloudproviders", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-exempi", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libportal", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gcr", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libsoup", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gvfs", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libxfce4util", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-xfconf", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libxfce4ui", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-exo", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-garcon", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-tumbler", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-thunar", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libyaml", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libfyaml", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libxmlb", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-appstream", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-appstream-glib", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-glib-networking", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-poppler-data", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-aalib", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-jasper", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libraw", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-babl", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gegl", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libmypaint", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-mypaint-brushes", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-imagemagick", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gimp", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-bluez", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-pycairo", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-pygobject", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-blueman", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-bluez-tools", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-7zip", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cpio", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-unrar", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-zip", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-rpcsvc-proto", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libtirpc", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-which", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cups-pk-helper", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-acpid", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-at", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-autofs", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-logrotate", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-lm-sensors", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-pciutils", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-usbutils", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-sg3-utils", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-power-profiles-daemon", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-hdparm", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-sysstat", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-fcron", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-gpm", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-lsb-tools", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-mc", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-modemmanager", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-notification-daemon", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-pax", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-pm-utils", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libuv", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libevent", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libpcap", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-bind", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-nmap", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-wireless-tools", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-rpcbind", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-nfs-utils", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libnsl", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-krb5", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cyrus-sasl", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-openldap", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-talloc", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-samba", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-cifs-utils", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libmnl", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libnftnl", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-nftables", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-iptables", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-wireguard-tools", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-openvpn", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-strongswan", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-ipset", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libnfnetlink", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libnetfilter-conntrack", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-conntrack-tools", descriptorName: "xbee-pack-builder.yaml"},
		{folder: "native/package-blfs-libcap-ng", descriptorName: "xbee-pack-builder.yaml"},
...
func TestBuildScriptsHaveValidBashSyntax(t *testing.T) {
	scripts := []string{
		...
		"native/blfs-sources/resources/download-blfs-sources.sh",
	...
	packageRecipes, err := filepath.Glob(
		"native/package-blfs-*/resources/build.sh",
	)
	if err != nil {
		t.Fatal(err)
	}
	scripts = append(scripts, packageRecipes...)
...
func TestNativeSourceManifest(t *testing.T) {
	...
	validateSourceManifest(t, "native/blfs-sources/resources/sources.tsv", 453)
}
